...
class App:
    ...
    def salvar_informacoes(self):
        ...
        self.cursor.execute('''
        INSERT INTO Crianças (nome, data_nascimento, telefone, endereco, cpf_responsavel, rg_resp, nome_resp, projeto, declaracao_escolar, vacinacao, termo_imagem)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)

        ''', (nome, data_nascimento, telefone, endereco, cpf, rg, nome_resp, projeto, declaracao, vacinacao, termo))
        conexao.commit()
...
# Inserir os dados no banco de dados
    ...
    def abrir_janela_consulta_crianca(self):
        ...
        self.tree = ttk.Treeview(frame_tree, columns=(
            ...
            "Projeto", "Declaração escolar", "Vacinação", "Termo de imagem", "Faltas"), show="headings", style="Treeview")
